        ...
        <div className="flex flex-col">
          ...
          <div className="mt-2 flex justify-end">
            <button
              ...
              className="mr-2 px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition-colors"
            >
              Delete
            </button>
            <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {services.length > 0 && Array.isArray(services) ? (
              services.map((service) => (
                <div
                  key={service._id}
                  className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 relative flex flex-col"
                >
                  {service.images && service.images.length > 0 && (
                    <img
                      src={service.images[0]}
                      alt={service.title || "Unnamed Service"}
                      className="w-full h-48 object-cover sm:h-40 md:h-48 lg:h-56"
                    />
                  )}
                  <div className="p-4 flex-1 flex flex-col">
                    ...
                    <button
                      onClick={() => handleViewDetails(service._id)}
                      className="mt-4 bg-orange-500 text-white py-2 px-4 rounded-2xl transition-colors duration-200 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-opacity-50"
                    >
                      View Details
                    </button>
                  </div>
                  ...
                  <AnimatePresence>
                    {dropdownOpen === service._id && (
                      <motion.div
                        ref={dropdownRef}
                        className="absolute top-12 right-4 bg-white border border-gray-200 rounded-md shadow-lg z-10 w-32"
                        initial={{ opacity: 0, scale: 0.95 }}
                        animate={{ opacity: 1, scale: 1 }}
                        exit={{ opacity: 0, scale: 0.95 }}
                        transition={{ duration: 0.2 }}
