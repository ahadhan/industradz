...
import SalesTrendChart from "../dashboard/components/sales/DailySalesTrend";
import ProductsTable from "../dashboard/components/services/ProductsTable";
	...
	return (
		<div className='flex-1 overflow-auto relative z-10'>
			...
			<main className='max-w-7xl mx-auto py-6 px-4 lg:px-8'>
				...
				>
					<StatCard name='Total services' icon={Package} value={0} color='#6366F1' />
